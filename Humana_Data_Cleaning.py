...
matt_clean = train[['ID','auth_3mth_post_acute_mus', 'bh_ip_snf_net_paid_pmpm_cost_6to9m_b4',
...
brandon_clean = train.iloc[:,1:92]
josh_clean = train.iloc[:,92:184]
matt_clean = train.iloc[:,184:276]
sara_clean = train.iloc[:,276:]
...
#Convert to float
matt_clean[dirty_columns] = matt_clean[dirty_columns].astype(float)
